 ...
 *
 * @module    mod_hippotrack/random_question_form_preview
...
define(
    ...
    function (
        ...
        var TEMPLATE_NAME = 'mod_hippotrack/random_question_form_preview_question_list';
        var SELECTORS = {
        ...
        var renderQuestionCount = function (root, questionCount) {
            Str.get_string('questionsmatchingfilter', 'mod_hippotrack', questionCount)
