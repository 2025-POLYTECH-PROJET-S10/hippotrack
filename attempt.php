...
if (empty($difficulty)) {
    ...
    $easy_url = new moodle_url('/mod/hippotrack/attempt.php', array('id' => $cmid, 'difficulty' => 'easy'));
    $hard_url = new moodle_url('/mod/hippotrack/attempt.php', array('id' => $cmid, 'difficulty' => 'hard'));
...
foreach ($possible_inputs as $field) {
    ...
    $new_question_url = new moodle_url('/mod/hippotrack/attempt.php', array('id' => $cmid, 'difficulty' => $difficulty, 'new_question' => 1));
    $finish_url = new moodle_url('/mod/hippotrack/view.php', array('id' => $cmid));
...
echo html_writer::start_tag('form', array('method' => 'post', 'action' => 'attempt.php?id=' . $cmid . '&difficulty=' . $difficulty . '&submitted=1'));
