...
/**
 * The mod_hippotrack attempt deleted event.
 *
...
/**
 * The mod_hippotrack attempt deleted event class.
 *
...
class attempt_deleted extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventattemptdeleted', 'mod_hippotrack');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' deleted the attempt with id '$this->objectid' belonging to the hippotrack " .
    ...
    protected function get_legacy_logdata() {
        return array($this->courseid, 'hippotrack', 'delete attempt', 'report.php?id=' . $this->contextinstanceid,
