...
/**
 * The mod_hippotrack attempt preview started event.
 *
...
/**
 * The mod_hippotrack attempt preview started event class.
 *
...
class attempt_preview_started extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventattemptpreviewstarted', 'mod_hippotrack');
    }
    ...
    public function get_url() {
        return new \moodle_url('/mod/hippotrack/view.php', array('id' => $this->contextinstanceid));
    }
