...
/**
 * The mod_hippotrack attempt reviewed event.
 *
...
/**
 * The mod_hippotrack attempt reviewed event class.
 *
...
class attempt_reviewed extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventattemptreviewed', 'mod_hippotrack');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' has reviewed hippotrack attempt with id '$this->objectid' by user ".
    ...
    protected function get_legacy_logdata() {
        return array($this->courseid, 'hippotrack', 'review', 'review.php?attempt=' . $this->objectid,
