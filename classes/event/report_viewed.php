...
class report_viewed extends \core\event\base {
    ...
    public function get_description() {
        return "The user with id '$this->userid' viewed the report '" . s($this->other['reportname']) . "' for the hippotrack with " .
    ...
    protected function get_legacy_logdata() {
        return array($this->courseid, 'hippotrack', 'report', 'report.php?id=' . $this->contextinstanceid . '&mode=' .
            $this->other['reportname'], $this->other['hippotrackid'], $this->contextinstanceid);
    }
