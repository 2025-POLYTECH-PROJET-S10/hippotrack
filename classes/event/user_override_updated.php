...
/**
 * The mod_hippotrack user override updated event.
 *
...
/**
 * The mod_hippotrack user override updated event class.
 *
...
class user_override_updated extends \core\event\base {
    ...
    public function get_description() {
        return "The user with id '$this->userid' updated the override with id '$this->objectid' for the hippotrack with " .
    ...
    protected function get_legacy_logdata() {
        return array($this->courseid, 'hippotrack', 'edit override', 'overrideedit.php?id=' . $this->objectid, $this->other['hippotrackid'],
