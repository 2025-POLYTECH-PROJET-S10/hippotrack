...
$observers = array(
    ...
    array(
        ...
        'callback' => '\mod_hippotrack\group_observers::course_reset_ended',
    ),
    array(
        'eventname' => '\core\event\group_deleted',
        'callback' => '\mod_hippotrack\group_observers::group_deleted'
    ),
    array(
        'eventname' => '\core\event\group_member_added',
        'callback' => '\mod_hippotrack\group_observers::group_member_added',
    ),
    array(
        'eventname' => '\core\event\group_member_removed',
        'callback' => '\mod_hippotrack\group_observers::group_member_removed',
    ),

    // Handle our own \mod_hippotrack\event\attempt_submitted event, as a way to
