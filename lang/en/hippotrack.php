...
$string['editPageLink'] = 'This is the link to the edit page';
$string['hard'] = 'Hard';
$string['easy'] = 'Easy';
$string['difficulty_type'] = 'What level of difficulty would you like for the question {$a}?';
$string['edit_form_main_text'] = 'This is where you edit the content of the quizz';
$string['add_exercise'] = 'Add an exercice';
$string['question_type'] = 'What type of question would you like for question {$a}?';
$string['multiple_choice'] = 'Multiple Choice';
$string['true_false'] = 'True/False';
$string['short_answer'] = 'Short Answer';
$string['remove_question'] = 'Remove this question';
