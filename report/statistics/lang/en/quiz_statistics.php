...
/**
 * Strings for component 'hippotrack_statistics', language 'en', branch 'MOODLE_20_STABLE'
 *
...
$string['backtohippotrackreport'] = 'Back to main statistics report page.';
$string['calculatefrom'] = 'Calculate statistics from';
$string['calculatingallstats'] = 'Calculating statistics for hippotrack, questions and analysing response data';
...
$string['errorpowers'] = 'Error fetching data to calculate variance for hippotrack grades';
...
$string['getstatslocktimeoutdesc'] = 'How many seconds to wait for a lock when attempting to perform a statistics calculation for a hippotrack. This setting primarily exists for testing, do not modify it unless you know what you are doing.';
...
$string['negcovar_help'] = 'This question\'s grade for this set of attempts on the hippotrack varies in an opposite way to the overall attempt grade. This means overall attempt grade tends to be below average when the grade for this question is above average and vice-versa.

Our equation for effective question weight cannot be calculated in this case. The calculations for effective question weight for other questions in this hippotrack are the effective question weight for these questions if the highlighted questions with a negative covariance are given a maximum grade of zero.

If you edit a hippotrack and give these question(s) with negative covariance a max grade of zero then the effective question weight of these questions will be zero and the real effective question weight of other questions will be as calculated now.';
$string['nogradedattempts'] = 'No attempts have been made at this hippotrack, or all attempts have questions that need manual grading.';
...
$string['privacy:metadata'] = 'Although the HippoTrack Statistics plugin has database tables, the data is aggregate data and does not describe a unique indidividual.';
...
$string['hippotrackinformation'] = 'HippoTrack information';
$string['hippotrackname'] = 'HippoTrack name';
$string['hippotrackoverallstatistics'] = 'HippoTrack overall statistics';
$string['hippotrackstructureanalysis'] = 'HippoTrack structure analysis';
...
$string['statsfor'] = 'HippoTrack statistics (for {$a})';
