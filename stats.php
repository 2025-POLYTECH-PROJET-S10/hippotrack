...
// if (!has_capability('mod/easyvote:hostquizz', $context)) {
//     throw new moodle_exception(get_string('access_not_authorized', 'mod_easyvote'));
// }


$myURL = new moodle_url('/mod/easyvote/stats.php');
$PAGE->set_url($myURL);
