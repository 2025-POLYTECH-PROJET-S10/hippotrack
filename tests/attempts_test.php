...
/**
 * Unit tests for hippotrack attempt overdue handling
 *
...
class attempts_test extends \advanced_testcase {
    ...
    public function test_bulk_update_functions() {
        ...
        // Basic hippotrack settings

        $hippotrack = $hippotrackgenerator->create_instance(['course' => $course->id, 'timeclose' => 1200, 'timelimit' => 600]);
        $attemptid = $DB->insert_record('hippotrack_attempts', ['hippotrack' => $hippotrack->id, 'userid' => $user1->id, 'state' => 'inprogress',
                'timestart' => 100, 'timecheckstate' => 0, 'layout' => '', 'uniqueid' => $this->usage_id($hippotrack)]);
        $usertimes[$attemptid] = ['timeclose' => 1200, 'timelimit' => 600, 'message' => 'Test1A', 'time1000state' => 'finished'];

        $hippotrack = $hippotrackgenerator->create_instance(['course' => $course->id, 'timeclose' => 1200, 'timelimit' => 1800]);
        $attemptid = $DB->insert_record('hippotrack_attempts', ['hippotrack' => $hippotrack->id, 'userid' => $user1->id, 'state' => 'inprogress',
                'timestart' => 100, 'timecheckstate' => 0, 'layout' => '', 'uniqueid' => $this->usage_id($hippotrack)]);
        $usertimes[$attemptid] = ['timeclose' => 1200, 'timelimit' => 1800, 'message' => 'Test1B', 'time1000state' => 'inprogress'];

        $hippotrack = $hippotrackgenerator->create_instance(['course' => $course->id, 'timeclose' => 1200, 'timelimit' => 0]);
        $attemptid = $DB->insert_record('hippotrack_attempts', ['hippotrack' => $hippotrack->id, 'userid' => $user1->id, 'state' => 'inprogress',
                'timestart' => 100, 'timecheckstate' => 0, 'layout' => '', 'uniqueid' => $this->usage_id($hippotrack)]);
        $usertimes[$attemptid] = ['timeclose' => 1200, 'timelimit' => 0, 'message' => 'Test1C', 'time1000state' => 'inprogress'];

        $hippotrack = $hippotrackgenerator->create_instance(['course' => $course->id, 'timeclose' => 0, 'timelimit' => 600]);
        $attemptid = $DB->insert_record('hippotrack_attempts', ['hippotrack' => $hippotrack->id, 'userid' => $user1->id, 'state' => 'inprogress',
                'timestart' => 100, 'timecheckstate' => 0, 'layout' => '', 'uniqueid' => $this->usage_id($hippotrack)]);
        $usertimes[$attemptid] = ['timeclose' => 0, 'timelimit' => 600, 'message' => 'Test1D', 'time1000state' => 'finished'];

        $hippotrack = $hippotrackgenerator->create_instance(['course' => $course->id, 'timeclose' => 0, 'timelimit' => 0]);
        $attemptid = $DB->insert_record('hippotrack_attempts', ['hippotrack' => $hippotrack->id, 'userid' => $user1->id, 'state' => 'inprogress',
                'timestart' => 100, 'timecheckstate' => 0, 'layout' => '', 'uniqueid' => $this->usage_id($hippotrack)]);
        ...
        $DB->insert_record('hippotrack_overrides',
                ['hippotrack' => $hippotrack->id, 'groupid' => $group1->id, 'timeclose' => 1300, 'timelimit' => null]);
        $usertimes[$attemptid] = ['timeclose' => 1300, 'timelimit' => 0, 'message' => 'Test2A', 'time1000state' => 'inprogress'];

        $hippotrack = $hippotrackgenerator->create_instance(['course' => $course->id, 'timeclose' => 1200, 'timelimit' => 0]);
        $DB->insert_record('hippotrack_overrides',
                ['hippotrack' => $hippotrack->id, 'groupid' => $group1->id, 'timeclose' => 1100, 'timelimit' => null]);
        $attemptid = $DB->insert_record('hippotrack_attempts', ['hippotrack' => $hippotrack->id, 'userid' => $user1->id, 'state' => 'inprogress',
                'timestart' => 100, 'timecheckstate' => 0, 'layout' => '', 'uniqueid' => $this->usage_id($hippotrack)]);
        ...
        $DB->insert_record('hippotrack_overrides',
                ['hippotrack' => $hippotrack->id, 'groupid' => $group1->id, 'timeclose' => null, 'timelimit' => 700]);
        $attemptid = $DB->insert_record('hippotrack_attempts', ['hippotrack' => $hippotrack->id, 'userid' => $user1->id, 'state' => 'inprogress',
                'timestart' => 100, 'timecheckstate' => 0, 'layout' => '', 'uniqueid' => $this->usage_id($hippotrack)]);
        ...
        $hippotrack = $hippotrackgenerator->create_instance(['course' => $course->id, 'timeclose' => 0, 'timelimit' => 600]);
        $DB->insert_record('hippotrack_overrides',
                ['hippotrack' => $hippotrack->id, 'groupid' => $group1->id, 'timeclose' => null, 'timelimit' => 500]);
        $attemptid = $DB->insert_record('hippotrack_attempts', ['hippotrack' => $hippotrack->id, 'userid' => $user1->id, 'state' => 'inprogress',
                'timestart' => 100, 'timecheckstate' => 0, 'layout' => '', 'uniqueid' => $this->usage_id($hippotrack)]);
        ...
        $hippotrack = $hippotrackgenerator->create_instance(['course' => $course->id, 'timeclose' => 0, 'timelimit' => 600]);
        $DB->insert_record('hippotrack_overrides',
                ['hippotrack' => $hippotrack->id, 'groupid' => $group1->id, 'timeclose' => null, 'timelimit' => 0]);
        $attemptid = $DB->insert_record('hippotrack_attempts', ['hippotrack' => $hippotrack->id, 'userid' => $user1->id, 'state' => 'inprogress',
                'timestart' => 100, 'timecheckstate' => 0, 'layout' => '', 'uniqueid' => $this->usage_id($hippotrack)]);
        ...
        $hippotrack = $hippotrackgenerator->create_instance(['course' => $course->id, 'timeclose' => 1200, 'timelimit' => 600]);
        $DB->insert_record('hippotrack_overrides',
                ['hippotrack' => $hippotrack->id, 'groupid' => $group1->id, 'timeclose' => 1300, 'timelimit' => 500]);
        $attemptid = $DB->insert_record('hippotrack_attempts', ['hippotrack' => $hippotrack->id, 'userid' => $user1->id, 'state' => 'inprogress',
                'timestart' => 100, 'timecheckstate' => 0, 'layout' => '', 'uniqueid' => $this->usage_id($hippotrack)]);
        $usertimes[$attemptid] = ['timeclose' => 1300, 'timelimit' => 500, 'message' => 'Test2F', 'time1000state' => 'finished'];
        $attemptid = $DB->insert_record('hippotrack_attempts', ['hippotrack' => $hippotrack->id, 'userid' => $user1->id, 'state' => 'inprogress',
                'timestart' => 1000, 'timecheckstate' => 0, 'layout' => '', 'uniqueid' => $this->usage_id($hippotrack), 'attempt' => 1]);
        $usertimes[$attemptid] = ['timeclose' => 1300, 'timelimit' => 500, 'message' => 'Test2G', 'time1000state' => 'inprogress'];

        $hippotrack = $hippotrackgenerator->create_instance(['course' => $course->id, 'timeclose' => 1200, 'timelimit' => 600]);
        $DB->insert_record('hippotrack_overrides',
                ['hippotrack' => $hippotrack->id, 'groupid' => $group3->id, 'timeclose' => 1300, 'timelimit' => 500]); // User not in group.
        $attemptid = $DB->insert_record('hippotrack_attempts', ['hippotrack' => $hippotrack->id, 'userid' => $user1->id, 'state' => 'inprogress',
                'timestart' => 100, 'timecheckstate' => 0, 'layout' => '', 'uniqueid' => $this->usage_id($hippotrack)]);
        ...
        $hippotrack = $hippotrackgenerator->create_instance(['course' => $course->id, 'timeclose' => 1200, 'timelimit' => 600]);
        $DB->insert_record('hippotrack_overrides',
                ['hippotrack' => $hippotrack->id, 'groupid' => $group1->id, 'timeclose' => 1300, 'timelimit' => 501]);
        $DB->insert_record('hippotrack_overrides',
                ['hippotrack' => $hippotrack->id, 'groupid' => $group2->id, 'timeclose' => 1301, 'timelimit' => 500]);
        $attemptid = $DB->insert_record('hippotrack_attempts', ['hippotrack' => $hippotrack->id, 'userid' => $user1->id, 'state' => 'inprogress',
                'timestart' => 100, 'timecheckstate' => 0, 'layout' => '', 'uniqueid' => $this->usage_id($hippotrack)]);
        ...
        $hippotrack = $hippotrackgenerator->create_instance(['course' => $course->id, 'timeclose' => 1200, 'timelimit' => 600]);
        $DB->insert_record('hippotrack_overrides',
                ['hippotrack' => $hippotrack->id, 'groupid' => $group1->id, 'timeclose' => 1301, 'timelimit' => 500]);
        $DB->insert_record('hippotrack_overrides',
                ['hippotrack' => $hippotrack->id, 'groupid' => $group2->id, 'timeclose' => 1300, 'timelimit' => 501]);
        $attemptid = $DB->insert_record('hippotrack_attempts', ['hippotrack' => $hippotrack->id, 'userid' => $user1->id, 'state' => 'inprogress',
                'timestart' => 100, 'timecheckstate' => 0, 'layout' => '', 'uniqueid' => $this->usage_id($hippotrack)]);
        ...
        $DB->insert_record('hippotrack_overrides',
                ['hippotrack' => $hippotrack->id, 'groupid' => $group2->id, 'timeclose' => 1300, 'timelimit' => 501]);
        $DB->insert_record('hippotrack_overrides',
                ['hippotrack' => $hippotrack->id, 'groupid' => $group3->id, 'timeclose' => 1500, 'timelimit' => 1000]); // User not in group.
        $attemptid = $DB->insert_record('hippotrack_attempts', ['hippotrack' => $hippotrack->id, 'userid' => $user1->id, 'state' => 'inprogress',
                'timestart' => 100, 'timecheckstate' => 0, 'layout' => '', 'uniqueid' => $this->usage_id($hippotrack)]);
        ...
        $DB->insert_record('hippotrack_overrides',
                ['hippotrack' => $hippotrack->id, 'groupid' => $group1->id, 'timeclose' => 1300, 'timelimit' => 500]);
        $DB->insert_record('hippotrack_overrides',
                ['hippotrack' => $hippotrack->id, 'groupid' => $group2->id, 'timeclose' => null, 'timelimit' => 501]);
        $attemptid = $DB->insert_record('hippotrack_attempts', ['hippotrack' => $hippotrack->id, 'userid' => $user1->id, 'state' => 'inprogress',
                'timestart' => 100, 'timecheckstate' => 0, 'layout' => '', 'uniqueid' => $this->usage_id($hippotrack)]);
        ...
        $DB->insert_record('hippotrack_overrides',
                ['hippotrack' => $hippotrack->id, 'groupid' => $group1->id, 'timeclose' => 1300, 'timelimit' => 500]);
        $DB->insert_record('hippotrack_overrides',
                ['hippotrack' => $hippotrack->id, 'groupid' => $group2->id, 'timeclose' => 1301, 'timelimit' => null]);
        $attemptid = $DB->insert_record('hippotrack_attempts', ['hippotrack' => $hippotrack->id, 'userid' => $user1->id, 'state' => 'inprogress',
                'timestart' => 100, 'timecheckstate' => 0, 'layout' => '', 'uniqueid' => $this->usage_id($hippotrack)]);
        ...
        $DB->insert_record('hippotrack_overrides',
                ['hippotrack' => $hippotrack->id, 'groupid' => $group1->id, 'timeclose' => 1300, 'timelimit' => 500]);
        $DB->insert_record('hippotrack_overrides',
                ['hippotrack' => $hippotrack->id, 'groupid' => $group2->id, 'timeclose' => 1301, 'timelimit' => 0]);
        $attemptid = $DB->insert_record('hippotrack_attempts', ['hippotrack' => $hippotrack->id, 'userid' => $user1->id, 'state' => 'inprogress',
                'timestart' => 100, 'timecheckstate' => 0, 'layout' => '', 'uniqueid' => $this->usage_id($hippotrack)]);
        ...
        $DB->insert_record('hippotrack_overrides',
                ['hippotrack' => $hippotrack->id, 'groupid' => $group1->id, 'timeclose' => 1300, 'timelimit' => 500]);
        $DB->insert_record('hippotrack_overrides',
                ['hippotrack' => $hippotrack->id, 'groupid' => $group2->id, 'timeclose' => 0, 'timelimit' => 501]);
        $attemptid = $DB->insert_record('hippotrack_attempts', ['hippotrack' => $hippotrack->id, 'userid' => $user1->id, 'state' => 'inprogress',
                'timestart' => 100, 'timecheckstate' => 0, 'layout' => '', 'uniqueid' => $this->usage_id($hippotrack)]);
        ...
        $hippotrack = $hippotrackgenerator->create_instance(['course' => $course->id, 'timeclose' => 1200, 'timelimit' => 600]);
        $DB->insert_record('hippotrack_overrides',
                ['hippotrack' => $hippotrack->id, 'groupid' => $group1->id, 'timeclose' => 1300, 'timelimit' => 700]);
        $DB->insert_record('hippotrack_overrides',
                ['hippotrack' => $hippotrack->id, 'userid' => $user1->id, 'timeclose' => 1201, 'timelimit' => 601]);
        $attemptid = $DB->insert_record('hippotrack_attempts', ['hippotrack' => $hippotrack->id, 'userid' => $user1->id, 'state' => 'inprogress',
                'timestart' => 100, 'timecheckstate' => 0, 'layout' => '', 'uniqueid' => $this->usage_id($hippotrack)]);
        ...
        $DB->insert_record('hippotrack_overrides',
                ['hippotrack' => $hippotrack->id, 'groupid' => $group1->id, 'timeclose' => 1300, 'timelimit' => 700]);
        $DB->insert_record('hippotrack_overrides',
                ['hippotrack' => $hippotrack->id, 'userid' => $user1->id, 'timeclose' => 0, 'timelimit' => 601]);
        $attemptid = $DB->insert_record('hippotrack_attempts', ['hippotrack' => $hippotrack->id, 'userid' => $user1->id, 'state' => 'inprogress',
                'timestart' => 100, 'timecheckstate' => 0, 'layout' => '', 'uniqueid' => $this->usage_id($hippotrack)]);
        ...
        $DB->insert_record('hippotrack_overrides',
                ['hippotrack' => $hippotrack->id, 'groupid' => $group1->id, 'timeclose' => 1300, 'timelimit' => 700]);
        $DB->insert_record('hippotrack_overrides',
                ['hippotrack' => $hippotrack->id, 'userid' => $user1->id, 'timeclose' => 1201, 'timelimit' => 0]);
        $attemptid = $DB->insert_record('hippotrack_attempts', ['hippotrack' => $hippotrack->id, 'userid' => $user1->id, 'state' => 'inprogress',
                'timestart' => 100, 'timecheckstate' => 0, 'layout' => '', 'uniqueid' => $this->usage_id($hippotrack)]);
        ...
        $DB->insert_record('hippotrack_overrides',
                ['hippotrack' => $hippotrack->id, 'groupid' => $group1->id, 'timeclose' => 1300, 'timelimit' => 700]);
        $DB->insert_record('hippotrack_overrides',
                ['hippotrack' => $hippotrack->id, 'userid' => $user1->id, 'timeclose' => null, 'timelimit' => 601]);
        $attemptid = $DB->insert_record('hippotrack_attempts', ['hippotrack' => $hippotrack->id, 'userid' => $user1->id, 'state' => 'inprogress',
                'timestart' => 100, 'timecheckstate' => 0, 'layout' => '', 'uniqueid' => $this->usage_id($hippotrack)]);
        ...
        $DB->insert_record('hippotrack_overrides',
                ['hippotrack' => $hippotrack->id, 'groupid' => $group1->id, 'timeclose' => 1300, 'timelimit' => 700]);
        $DB->insert_record('hippotrack_overrides',
                ['hippotrack' => $hippotrack->id, 'userid' => $user1->id, 'timeclose' => 1201, 'timelimit' => null]);
        $attemptid = $DB->insert_record('hippotrack_attempts', ['hippotrack' => $hippotrack->id, 'userid' => $user1->id, 'state' => 'inprogress',
                'timestart' => 100, 'timecheckstate' => 0, 'layout' => '', 'uniqueid' => $this->usage_id($hippotrack)]);
        ...
        $DB->insert_record('hippotrack_overrides',
                ['hippotrack' => $hippotrack->id, 'groupid' => $group1->id, 'timeclose' => 1300, 'timelimit' => 700]);
        $DB->insert_record('hippotrack_overrides',
                ['hippotrack' => $hippotrack->id, 'userid' => 0, 'timeclose' => 1201, 'timelimit' => 601]); // Not user.
        $attemptid = $DB->insert_record('hippotrack_attempts', ['hippotrack' => $hippotrack->id, 'userid' => $user1->id, 'state' => 'inprogress',
                'timestart' => 100, 'timecheckstate' => 0, 'layout' => '', 'uniqueid' => $this->usage_id($hippotrack)]);
        ...
        $attemptid = $DB->insert_record('hippotrack_attempts', ['hippotrack' => $hippotrack->id, 'userid' => $user1->id, 'state' => 'overdue',
                'timestart' => 100, 'timecheckstate' => 0, 'layout' => '', 'uniqueid' => $this->usage_id($hippotrack)]);
        ...
        foreach ($usertimes as $attemptid => $times) {
            ...
            if ($attempt->state == 'overdue') {
                $graceperiod = $DB->get_field('hippotrack', 'graceperiod', ['id' => $attempt->hippotrack]);
            } else {
                $graceperiod = 0;
            }
        ...
        [$count, $hippotrackcount] = $overduehander->update_overdue_attempts(1000, 940);

        $attempts = $DB->get_records('hippotrack_attempts', null, 'hippotrack, userid, attempt',
                'id, hippotrack, userid, attempt, state, timestart, timefinish, timecheckstate');
        foreach ($attempts as $attempt) {
            $this->assertTrue(isset($usertimes[$attempt->id]));
            $times = $usertimes[$attempt->id];
        ...
        $this->assertEquals(19, $hippotrackcount);
    }

    /**
     * Make any old question usage for a hippotrack.
     *
     ...
     */
    protected function usage_id(\stdClass $hippotrack): int {
        $quba = question_engine::make_questions_usage_by_activity('mod_hippotrack',
                \context_module::instance($hippotrack->cmid));
    ...
    public function test_group_event_handlers() {
        ...
        hippotrack_update_open_attempts(['hippotrackid' => $hippotrack->id]);
        ...
        $this->assertEquals(1200, $DB->get_field('hippotrack_attempts', 'timecheckstate', ['id' => $attemptid]));
        $this->assertEquals(0, $DB->count_records('hippotrack_overrides', ['hippotrack' => $hippotrack->id]));

        // add a group2 override
        $DB->insert_record('hippotrack_overrides',
                ['hippotrack' => $hippotrack->id, 'groupid' => $group2->id, 'timeclose' => 1400, 'timelimit' => null]);
        hippotrack_update_open_attempts(['hippotrackid' => $hippotrack->id]);
    ...
    public function test_hippotrack_create_attempt_handling_errors() {
        ...
        $hippotrack = $hippotrackgenerator->create_instance(['course' => $course->id, 'questionsperpage' => 0, 'grade' => 100.0,
            'sumgrades' => 2]);
        // Create questions.
        ...
        $timenow = time();
        // Create an attempt.
        $attempt = hippotrack_create_attempt($hippotrackobj, 1, null, $timenow, false, $user1->id);
        ...
        $result = hippotrack_create_attempt_handling_errors($attempt->id, $hippotrack->cmid);
        ...
        try {
            ...
            $this->fail('Exception expected due to hippotrack content change.');
        } catch (\moodle_exception $e) {
            $this->assertEquals('attempterrorcontentchange', $e->errorcode);
        }
        try {
            hippotrack_create_attempt_handling_errors(9999);
            $this->fail('Exception expected due to invalid hippotrack attempt id.');
        } catch (\moodle_exception $e) {
        ...
        try {
            hippotrack_create_attempt_handling_errors(9999, $result->get_cmid());
            $this->fail('Exception expected due to hippotrack content change for user without permission.');
        } catch (\moodle_exception $e) {
