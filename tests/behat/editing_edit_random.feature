...
Feature: Editing random questions already in a hippotrack based on category and tags
  ...
  Scenario: Editing tags on one slot does not delete the rest
    ...
    Then I should see "Random (Questions Category 1, tags: essay)" on hippotrack page "1"
    And I should see "Random (Questions Category 1, tags: hard)" on hippotrack page "2"
