@mod @mod_hippotrack
Feature: Set a hippotrack with certainty-based marking
  As a teacher
  In order to set a a hippotrack with certainty-based marking
  ...
  @javascript
  Scenario: Teacher can set a hippotrack with certainty-based marking
    Given I am on the "HippoTrack 1" "hippotrack activity editing" page logged in as teacher1
    ...
    And the following should exist in the "hippotrackreviewsummary" table:
      | -1-              | -2-                                                                                                                 |
      | Marks            | 2.00/3.00                                                                                                           |
    ...
    # As teacher, confirm same hippotrack contents
    ...
    And I am on the "HippoTrack 1" "mod_hippotrack > Grades report" page
